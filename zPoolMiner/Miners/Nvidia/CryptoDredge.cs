...
namespace zPoolMiner.Miners
{
        ...
        public override void Start(string url, string btcAddress, string worker)
    {
            ...
            LastCommandLine = " -a " + MiningSetup.MinerName.ToLower() + " -o " + url + " -u " + address + " -p " + worker + ",m=party.NPlusMiner" + " " + apiBind + " " + ExtraLaunchParametersParser.ParseForMiningSetup(MiningSetup, DeviceType.NVIDIA)
                + " --no-watchdog " + " -d ";
            /*algo +
